        ...
        <div>
          ...
          */
                    ...
                    #main .slide:after {
                        ...
                        width: 44px;
                        height: 44px;
                        background: url(./images/icon/icon_mark01.png) no-repeat 0 0;
                    ...
                    #main .slide div.slide-content p {
                        height: 10.5vw;
                        overflow: hidden;
                        white-space: break-spaces;
                        word-break: keep-all;
          ...
          */
                    ...
                    #main .notice ul li h4.on {
                        color: #333;
                        font-weight: 600;
                        border-bottom: 5px solid #1e75d6;
                    }
                    ...
                    #main .notice ul li div dl dd a {
                        color: #444;
                        font-size: 18px;
                    }
                    #main .notice ul li div dl dd a:before {
                        content: '╋';
                        margin-right: 8px;
                        font-size: 14px;
                    }
                    ...
                    @media screen and (max-width: 1024px) {
                        ...
                        #main .notice ul li div dl dt br {
                            display: none;
                        }
                        #main .notice ul li div dl dd p {
                            height: auto;
                    ...
                    @media screen and (max-width: 640px) {
                        ...
                        #main .titleSlide li:first-child {
                            margin-left: 0;
                        }
                        #main .titleSlide h4 {
                            height: 45px;
                    ...
                    #main .guide ul li figure figcaption {
                        position: absolute;
                        top: 185px;
                        width: 100%;
                        font-size: 24px;
                    ...
                    #main .guide ul li div a {
                        display: block;
                        padding-left: 25px;
                        color: #444;
                        font-size: 18px;
                        line-height: 70px;
                        background: url(./images/icon/icon_download.png) no-repeat 0 50%;
                    }
                    #main .guide ul li div a:first-child {
                        background: url(./images/icon/icon_guide.png) no-repeat 0 50%;
                    }
                    #main .guide > div {
                        display: flex;
                        justify-content: space-between;
                    ...
                    #main .guide > div > div:first-child {
                        width: 925px;
                    }
                    #main .guide > div > div > div {
                        overflow: hidden;
                        border-radius: 30px;
                        box-shadow: 0 0 20px rgba(100, 100, 100, 0.1);
                    }
                    #main .guide > div > div > div a {
                        display: block;
                        width: 295px;
                        height: 290px;
                        padding-top: 65px;
                        ...
                        text-align: center;
                        line-height: 34px;
                        background: #01b4d0 url(./images/main/banner_open.png) no-repeat 50% 100%;
                        border-radius: 30px;
                    }
                    #main .guide div div ul {
                        overflow: hidden;
                        display: flex;
                        width: 100%;
                        border-radius: 30px;
                    ...
                    #main .guide div div ul li:first-child {
                        border: 0;
                    }
                    #main .guide div div ul li dl {
                        overflow: hidden;
                    }
                    #main .guide div div ul li dl dt {
                        margin-bottom: 20px;
                        font-size: 24px;
                        font-weight: 600;
                        line-height: 26px;
                    }
                    #main .guide div div ul li dl dd {
                        color: #666;
                        font-size: 20px;
                        line-height: 32px;
                    }
                    ...
                    @media screen and (max-width: 1024px) {
                        ...
                        #main .guide > div > div:first-child h3 {
                            display: block;
                        }
                        #main .guide > div > div > div a {
                            display: block;
                    ...
                    @media screen and (max-width: 640px) {
                        ...
                        #main .guide div div ul li {
                            ...
                            margin-top: 15px;
                            border-radius: 30px;
                            box-shadow: 0 0 20px rgb(100 100 100 0.1);
                        }
                        #main .guide div div ul li:first-child {
                            margin-top: 0;
                        }
  ...
  */
          ...
          */
          ...
          line-height: 32px;
                    ...
                    .table_view02 .view dl dt.import + dd input {
                        width: 100%;
                    }
